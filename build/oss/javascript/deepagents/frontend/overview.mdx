...
<CardGroup cols={3}>
  <Card title="Subagent 流式传输" icon="arrows-split" href="/oss/javascript/deepagents/frontend/subagent-streaming">
    显示 specialist subagents，包括流式内容、进度跟踪和可折叠卡片。
  </Card>
  <Card title="Todo 列表" icon="list-check" href="/oss/javascript/deepagents/frontend/todo-list">
